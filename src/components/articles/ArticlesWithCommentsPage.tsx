...
import ArticlesWithCommentsList from "./ArticlesWithCommentsList";

// endpoint examples : "/articles/", "/articles/categories?categoryIds=15,17"
// url exemples : "/", "/article?cat=tech-science"
export default async function ArticlesWithCommentsPage({
  endpoint,
  url,
  size = "classic",
  currentPage,
  ...
  return (
    <div className="flex flex-col gap-4">
      {articles.length > 0 ? (
        <>
          <ArticlesWithCommentsList articles={articles} />
          {totalPages > 1 && (
            <PaginationControls
